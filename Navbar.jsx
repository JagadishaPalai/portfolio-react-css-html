...
import "./Navbar.css";
import Pdf from './Jagadisha-Palai.pdf'
      ...
      <div className={`item ${showMenu ? "show-menu" : ""}`}>
        ...
        <ul>
          ...
          <div className="social">
            <a href="https://www.linkedin.com/in/jagadisha-palai-448780268/" target="_blank" rel="noreferrer">
              <FaLinkedin />
            </a>
            <a href="https://github.com/JagadishaPalai" target="_blank"rel="noreferrer">
              <FaSquareGithub />
            </a>
